...
export default async function Specialist({ params }: { params: { id: string } }) {
  const { errorCodeSpec, specialist } = await getSpecialist(params.id);
  if (errorCodeSpec) {
    return <NotFound />;
  }
            ...
            <div className="row gy-4 gy-md-0">
              ...
              <div className="col-md-8">
                <h1 className="doc-hero-name fw-extrabold mb-3">
                  ...
                  <span className="doc-hero-surname d-block text-uppercase fw-black">
                    {specialist.surname}
                  </span>
                </h1>
                ...
                <div className="row g-2 g-lg-3 mb-4">
                  {specialist.specializations.map((specialization: any) => (
                    <div key={specialization.id} className="col-auto">
                      <div className="doc-hero-badge bg-light-blue text-secondary rounded-pill">
                        {specialization.name}
                      </div>
                    </div>
                  ))}
          ...
          <div className="container">
            <div className="row">
              ...
              <div className="col-lg">
                <div
                  className="tab-content bg-white rounded-3 shadow p-xl-5 p-md-4 p-3"
                  id="DocInfo-tabContent"
                >
                  <div
                    className="tab-pane fade show active"
                    id="DocInfo-1"
                    role="tabpanel"
                    aria-labelledby="DocInfo-1-tab"
                    tabIndex={0}
                  >
                      ...
                      {/* <div className="col-xl-4 col-md-6">
                        <div className="gallery-item position-relative">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                "url('https://i3.ytimg.com/vi/PWv2zfJvebQ/maxresdefault.jpg')",
                            }}
                          >
                            <div className="gallery-item-play-icon">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                                <path d="M353.07,222.61l-124.76-68.33c-11.99-6.74-26.2-6.59-38.04,.3-11.86,6.93-18.94,19.29-18.94,33.02v136.77c0,13.74,7.08,26.09,18.94,33.02,6.04,3.52,12.69,5.29,19.31,5.29s12.8-1.64,18.62-4.91l124.95-68.44c12.2-6.87,19.5-19.33,19.5-33.32s-7.3-26.47-19.61-33.39l.02-.02ZM256,0C114.84,0,0,114.84,0,256s114.84,256,256,256,256-114.84,256-256S397.16,0,256,0Zm0,490.67c-129.39,0-234.67-105.28-234.67-234.67S126.61,21.33,256,21.33s234.67,105.28,234.67,234.67-105.28,234.67-234.67,234.67Z" />
                              </svg>
                            </div>
                          </div>
                      ...
                      <div className="col-xl-4 col-md-6">
                        <div className="gallery-item position-relative">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                "url('https://i3.ytimg.com/vi/59hnfy4THR0/maxresdefault.jpg')",
                            }}
                          >
                            <div className="gallery-item-play-icon">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                      ...
                      {/* <div className="col-xl-4 col-md-6">
                        <div className="gallery-item position-relative">
                          <div
                            ...
                            style={{
                              backgroundImage:
                                "url('https://i3.ytimg.com/vi/A-q7qVkJKxo/maxresdefault.jpg')",
                            }}
                          >
                            <div className="gallery-item-play-icon">
                              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                        ...
                        <div className="col-xl-4 col-md-6">
                          <div className="gallery-item position-relative">
                            <div
                              ...
                              style={{
                                backgroundImage:
                                  "url('http://i3.ytimg.com/vi/Zoo7aETBecs/hqdefault.jpg')",
                              }}
                            >
                              <div className="gallery-item-play-icon">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
