                        ...
                        <div className="row flex-column flex-md-row gx-0">
                          <div className="col-12 col-md-auto">
                            <div
                              ...
                              style={{
                                backgroundImage:
                                  "url('/img/dynamic-img/main-slider-img_1.jpg')",
                              }}
                            ></div>
                          </div>
                                ...
                                <ul className="sale-banner-list list-unstyled mt-2 mt-md-3 mt-xxl-4">
                                  <li>
                                    ...
                                    <div className="fw-bold">
                                      2600 ₽
                                      <span className="text-decoration-line-through fw-medium ms-1">
                                        3000 ₽
                                      </span>
                                    </div>
                                  </li>
            ...
            <div className="col-xl-4 col-xxl-3">
              <div className="main-banner d-flex align-content-stretch h-100 bg-white shadow rounded-3 overflow-hidden">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url('/img/dynamic-img/main-banner-img.jpg')",
                  }}
                ></div>

                <div className="flex-grow-1 pt-3 pb-3 px-3 p-sm-4 ps-md-5 ps-xl-4 pt-xl-5">
                  <h2 className="main-banner-title mb-2 mb-xl-2">
                    Онлайн-консультация
                  </h2>
        ...
        <section className="py-lg-6 py-5">
          <div className="container">
            <div className="d-flex flex-wrap align-items-baseline justify-content-between mb-lg-3">
              ...
              <a
                href="/catalog/services/categories/9"
            ...
            <div className="row align-items-end gy-5 gy-sm-6 gy-xl-0 gx-xl-6">
              <div className="col-xl-7">
                <article className="article mb-5 mb-lg-6">
                  <h1 className="title-dashed fs-2 pb-4 mb-4">
                    4Д Поликлиника
                  </h1>
                  <p>
                    Это сеть многопрофильных медицинских центров. В нашем
                    арсенале более 250 видов медицинских услуг, и это не считая
                    инструментальной диагностики - эндоскопии, УЗИ, МРТ, КТ, - а
                    также клинических исследований и анализов! Мы прикладываем
                    максимум усилий для того, чтобы в одном месте, за один визит
                    наши пациенты могли получить самую разнообразную помощь -
                ...
                <div className="feature d-flex bg-white shadow rounded-3 h-100 p-3 p-sm-4">
                  ...
                  <div className="my-auto">
                    ...
                    <div className="feature-text text-muted">
                      Каждый доктор 4Д Поликлиники – настоящий бриллиант в нашей
                      коллекции. Каждый – настоящий мастер своего дела. При
                      этом, наши специалисты не прекращают совершенствоваться и
              ...
              <div className="col-lg-6">
                <div className="feature d-flex bg-white shadow rounded-3 h-100 p-3 p-sm-4">
                  ...
                  <div className="my-auto">
                    ...
                    <div className="feature-text text-muted">
                      Продвинутое оборудование – то, на чём мы никогда не
                      экономим. Поэтому инструментальная диагностика в 4Д
                      Поликлинике – это всегда точно и профессионально.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6">
                <div className="feature d-flex bg-white shadow rounded-3 h-100 p-3 p-sm-4">
                  ...
                  <div className="my-auto">
                    ...
                    <div className="feature-text text-muted">
                      Мы за удобство. У нас вы можете пройти обследования, сдать
                      анализы и попасть на приём к врачу – за одно посещение.
                      Для того, чтобы быть здоровым не нужно тратить массу
                      времени и мотаться по всему городу.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6">
                <div className="feature d-flex bg-white shadow rounded-3 h-100 p-3 p-sm-4">
                  ...
                  <div className="my-auto">
                    ...
                    <div className="feature-text text-muted">
                      Наши поликлиники работают с раннего утра и до вечера, без
                      перерывов и без выходных. Мы заботимся о вашем здоровье и
                      продолжаем приём даже в праздники и по воскресеньям.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6">
                <div className="feature d-flex bg-white shadow rounded-3 h-100 p-3 p-sm-4">
                  ...
                  <div className="my-auto">
                    ...
                    <div className="feature-text text-muted">
                      В 4Д Поликлинике царит спокойная и расслабляющая атмосфера
                      благодаря искреннему желанию персонала предоставлять
                      пациентам тёплый, человечный уход.
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div className="col-lg-6">
                <div className="feature d-flex bg-white shadow rounded-3 h-100 p-3 p-sm-4">
                  ...
                  <div className="my-auto">
                    ...
                    <div className="feature-text text-muted">
                      Мы работаем для своих пациентов уже более 12 лет, с каждым
                      новым годом накапливаем всё больше опыта, что позволяет
                      нам всё время улучшать качество наших услуг.
                    </div>
                  </div>
                </div>
              </div>
                ...
                <div className="swiper-wrapper">
                  <div className="swiper-slide">
                    <div className="rate-item bg-white rounded-3 shadow-sm d-flex align-items-center p-sm-4 p-3">
                      ...
                      <div className="rate-item-score fw-bold text-danger me-3">
                        4.8
                      </div>
                      ...
                      <div>
                        ...
                        <div className="rate-item-count text-muted">
                          872 отзыва
                        </div>
                      </div>
                    </div>
