                            ...
                            {categories[0].documents.map((document: any) => (
                                <div key={document.name} className="col-xxl-3 col-xl-4 col-md-6">
                                    <div
                                        ...
                                        <a href={document.link} target="_blank" className="card-title stretched-link d-block text-secondary fw-bold mb-2">{document.name}</a>
                            ...
                            <>
                                ...
                                <ul>
                                    {category.documents.map((document: any) => (
                                        <li key={document.name}><a href={document.link} target="_blank">{document.name}</a></li>
                                    ))}
                                </ul>
                            </>
                        ))}
