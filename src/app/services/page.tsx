                                        ...
                                        <nav className="sidebar">
                                            <ul className="nav">
                                                ...
                                                <li className="nav-item">
                                                    <a className="nav-link" href="services-category.html">Приём врача</a>
                                                </li>
                                                ...
                                                <li className="nav-item has-submenu">
                                                    ...
                                                    <ul className="submenu collapse">
                                                        <li><a className="nav-link" href="services-category.html">МРТ периферической нервной системы</a></li>
                                                        <li><a className="nav-link" href="services-category.html">МРТ головы</a></li>
                                                        <li><a className="nav-link" href="services-category.html">МРТ внутренних органов</a></li>
                                                        <li><a className="nav-link" href="services-category.html">МРТ мягких тканей</a></li>
                                                        <li><a className="nav-link" href="services-category.html">МРТ при беременности</a></li>
                                                        <li><a className="nav-link" href="services-category.html">МРТ позвоночника</a></li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li className="nav-item has-submenu">
                                                    ...
                                                    <ul className="submenu collapse">
                                                        <li><a className="nav-link" href="services-category.html">Флебология</a></li>
                                                        <li><a className="nav-link" href="services-category.html">Маммология</a></li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li className="nav-item has-submenu">
                                                    ...
                                                    <ul className="submenu collapse">
                                                        <li><a className="nav-link" href="services-category.html">Рентген головы</a></li>
                                                        <li><a className="nav-link" href="services-category.html">Рентген тела</a></li>
                                                        <li><a className="nav-link" href="services-category.html">Рентген суставов костей</a></li>
                                                        <li><a className="nav-link" href="services-category.html">Дополнительные услуги</a></li>
                                                    </ul>
                                                </li>
                                                ...
                                                <li className="nav-item has-submenu">
                                                    ...
                                                    <ul className="submenu collapse">
                                                        <li><a className="nav-link" href="services-category.html">КТ головы</a></li>
                                                        <li><a className="nav-link" href="services-category.html">КТ с констрастом</a></li>
                                                        <li><a className="nav-link" href="services-category.html">КТ позвоночника</a></li>
                                                        <li><a className="nav-link" href="services-category.html">КТ суставов и костей</a></li>
                                                        <li><a className="nav-link" href="services-category.html">КТ внутренних органов</a></li>
                                                        <li><a className="nav-link" href="services-category.html">КТ мягких тканей</a></li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </nav>
                        ...
                        <div className="col-xxl-9 col-xl-8">
                            <div>
                                <div className="service-item position-relative">
                                    <div className="row gx-lg-6">
                                        <div className="col-md mb-3 my-md-auto">
                                            <a href="service.html" className="service-item-title stretched-link link-secondary d-block fw-bold">
                                                Ультразвуковая диагностика беременности
                                            </a>

                                            <p className="service-item-text text-muted pt-2 pt-md-1 mb-0">
                                                Исследование, позволяющее подтвердить беременность и определить место прикрепления плодного яйца (для исключения внематочной
                                                беременности).
                                            </p>
                                ...
                                <div className="service-item position-relative">
                                    <div className="row gx-lg-6">
                                        <div className="col-md mb-3 my-md-auto">
                                            ...
                                            <div className="service-item-badge d-inline-block bg-danger text-white mt-2 px-1">Скидка все выходные сентября</div>
                                        </div>

                                        <div className="col-12 col-md-auto">
                                            <div className="service-item-price h-100 d-flex flex-wrap flex-md-column align-items-end">
                                                <div className="pe-3 pe-md-0 pb-3 mb-md-auto me-auto me-md-0">
                                                    <div className="old-price text-decoration-line-through text-disabled lh-1 mb-1">3 200 ₽</div>
                                                    <div className="current-price text-danger fw-black lh-1">2 999 ₽</div>
                                                </div>
                                ...
                                <div className="service-item position-relative">
                                    <div className="row gx-lg-6">
                                        <div className="col-md mb-3 my-md-auto">
                                            <a href="service.html" className="service-item-title stretched-link link-secondary d-block fw-bold">
                                                Скрининговое УЗИ 1-го триместра беременности и расчет риска в программе Астрайя (11 - 13 недель 6 дней)
                                            </a>
                                        ...
                                        <div className="col-12 col-md-auto">
                                            <div className="service-item-price h-100 d-flex flex-wrap flex-md-column align-items-end">
                                                <div className="pe-3 pe-md-0 pb-3 mb-md-auto me-auto me-md-0">
                                                    <div className="current-price text-secondary fw-black lh-1">1 900 ₽</div>
                                                </div>
                                ...
                                <div className="service-item position-relative">
                                    <div className="row gx-lg-6">
                                        ...
                                        <div className="col-12 col-md-auto">
                                            <div className="service-item-price h-100 d-flex flex-wrap flex-md-column align-items-end">
                                                <div className="pe-3 pe-md-0 pb-3 mb-md-auto me-auto me-md-0">
                                                    <div className="current-price text-secondary fw-black lh-1">3 700 ₽</div>
                                                </div>
                                ...
                                <div className="service-item position-relative">
                                    <div className="row gx-lg-6">
                                        <div className="col-md mb-3 my-md-auto">
                                            ...
                                            <p className="service-item-text text-muted pt-2 pt-md-1 mb-0">
                                                Способ контроля многоплодной беременности во 2-м триместре с целью оценки развития плодов, состояния матки и плаценты, а также для
                                                изучения состоятельности кровообращения в системе мать-плацента-плод(ы) с помощью допплерометрии.
                                            </p>
                                        </div>
                                        ...
                                        <div className="col-12 col-md-auto">
                                            <div className="service-item-price h-100 d-flex flex-wrap flex-md-column align-items-end">
                                                <div className="pe-3 pe-md-0 pb-3 mb-md-auto me-auto me-md-0">
                                                    <div className="current-price text-secondary fw-black lh-1">2 200 ₽</div>
                                                </div>
                                ...
                                <div className="service-item position-relative">
                                    <div className="row gx-lg-6">
                                        ...
                                        <div className="col-12 col-md-auto">
                                            <div className="service-item-price h-100 d-flex flex-wrap flex-md-column align-items-end">
                                                <div className="pe-3 pe-md-0 pb-3 mb-md-auto me-auto me-md-0">
                                                    <div className="current-price text-secondary fw-black lh-1">2 700 ₽</div>
                                                </div>
                                ...
                                <div className="service-item position-relative">
                                    <div className="row gx-lg-6">
                                        ...
                                        <div className="col-12 col-md-auto">
                                            <div className="service-item-price h-100 d-flex flex-wrap flex-md-column align-items-end">
                                                <div className="pe-3 pe-md-0 pb-3 mb-md-auto me-auto me-md-0">
                                                    <div className="current-price text-secondary fw-black lh-1">4 600 ₽</div>
                                                </div>
                                ...
                                <div className="service-item position-relative">
                                    <div className="row gx-lg-6">
                                        ...
                                        <div className="col-12 col-md-auto">
                                            <div className="service-item-price h-100 d-flex flex-wrap flex-md-column align-items-end">
                                                <div className="pe-3 pe-md-0 pb-3 mb-md-auto me-auto me-md-0">
                                                    <div className="current-price text-secondary fw-black lh-1">1 300 ₽</div>
                                                </div>
                                ...
                                <div className="service-item position-relative">
                                    <div className="row gx-lg-6">
                                        ...
                                        <div className="col-12 col-md-auto">
                                            <div className="service-item-price h-100 d-flex flex-wrap flex-md-column align-items-end">
                                                <div className="pe-3 pe-md-0 pb-3 mb-md-auto me-auto me-md-0">
                                                    <div className="current-price text-secondary fw-black lh-1">1 199 ₽</div>
                                                </div>
                                ...
                                <div className="service-item position-relative">
                                    <div className="row gx-lg-6">
                                        ...
                                        <div className="col-12 col-md-auto">
                                            <div className="service-item-price h-100 d-flex flex-wrap flex-md-column align-items-end">
                                                <div className="pe-3 pe-md-0 pb-3 mb-md-auto me-auto me-md-0">
                                                    <div className="current-price text-secondary fw-black lh-1">820 ₽</div>
                                                </div>
                            ...
                            <div className="pt-5">
                                <ul className="pagination justify-content-center justify-content-sm-end">
                                    ...
                                    <li className="page-item"><a className="page-link" href="#">333</a></li>
                                    <li className="page-item">
                                        <a className="page-link" href="#">
                                            <span className="icon">
                                                {/* <?xml version="1.0" encoding="UTF-8"?> */}
