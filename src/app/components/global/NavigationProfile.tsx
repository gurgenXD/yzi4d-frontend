      ...
      {accessToken ? (
        <div className="dropdown">
          <a
            ...
            href={`/profile/${userId}?category=info`}
            role="button"
            aria-expanded="false"
          >
          ...
          <ul className="dropdown-menu dropdown-menu-end">
            <li>
              <a className="dropdown-item" href={`/profile/${userId}?category=visits`}>
                <span className="icon me-2">
            ...
            <li>
              <a className="dropdown-item" href={`/profile/${userId}?category=analyzes`}>
                <span className="icon me-2">
            ...
            <li>
              <a className="dropdown-item" href={`/profile/${userId}?category=settings`}>
                <span className="icon me-2">
