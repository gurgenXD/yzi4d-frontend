              ...
              {new Set([
                ...
                <>
                  {page == paging.current_page - 1 && page - 2 >= 1 ? (
                    <li className="page-item disabled" key="dis-pre">
                  ...
                  <li
                    className={"page-item" + (page == paging.current_page ? " active" : "")}
                    key={page}
                  >
                    <Link
                      className="page-link"
                      href={url + "?" + getPagingUrl(page.toString(), urlSearchParams)}
                    >
                      {page}
                    </Link>
                  </li>
                  ...
                  {page == paging.current_page + 1 && page + 2 <= paging.total_pages ? (
                    <li className="page-item disabled" key="dis-post">
                      <Link className="page-link" href="#">
                        ...
                      </Link>
                    </li>
