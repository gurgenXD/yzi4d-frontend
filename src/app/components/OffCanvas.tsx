                        ...
                        {/*
                            <li className="nav-item has-submenu">
                                ...
                                <ul className="submenu collapse">
                                    <li><a className="nav-link" href="department.html">Центр кардионефрологии</a></li>
                                </ul>
                            </li>
                        */}
