...
export default function HomeServices() {
    ...
    if (isLoading) return <PlaceholderLoading height={200} isLoading={isLoading} />
    if (isError) return <PlaceholderError height={200} isError={isError} />
                                ...
                                {category.services.map((service: any) => (
                                    <div key={service.id} className="col-xl-4 col-md-6">
                                        <div
                                            ...
                                            <a href={`/catalog/services/categories/items/${service.id}`} className="card-title stretched-link d-block text-secondary fw-bold mb-2">{service.name}</a>
