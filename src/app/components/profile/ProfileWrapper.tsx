          ...
          <nav className="sidebar">
            <ul className="nav">
              <li className="nav-item">
                <Link className={`nav-link ${category == "info" ? "active" : null}`} href={`${pathname}?${createQueryString("category", "info")}`}>
                  <span className="icon">
              ...
              <li className="nav-item">
                <Link className={`nav-link ${category == "visits" ? "active" : null}`} href={`${pathname}?${createQueryString("category", "visits")}`}>
                  <span className="icon">
              ...
              <li className="nav-item">
                <Link className={`nav-link ${category == "analyzes" ? "active" : null}`} href={`${pathname}?${createQueryString("category", "analyzes")}`}>
                  <span className="icon">
              ...
              <li className="nav-item">
                <Link className={`nav-link ${category == "settings" ? "active" : null}`} href={`${pathname}?${createQueryString("category", "settings")}`}>
                  <span className="icon">
