    ...
    return (
        <>
            ...
            <div className="tab-content" id="adresses-tabContent">
                <div className="tab-pane fade" id="adresses-1" role="tabpanel" aria-labelledby="adresses-1-tab" tabIndex={0}>
                    ...
                    <div className="bg-white shadow rounded-3 overflow-hidden mb-5">
                        <div className="row g-0">
                            <div className="col-lg-4 address-card-caption">
                                <div className="h-100 d-flex flex-column p-3 p-sm-4 p-md-5 p-lg-4 p-xl-5">
                                    <h3 className="address-card-title mb-3"><a href="branch.html" className="link-secondary">4Д на Пушкинской</a></h3>
                ...
                <div className="tab-pane fade show active" id="adresses-2" role="tabpanel" aria-labelledby="adresses-2-tab" tabIndex={0}>
                    <div className="bg-white shadow rounded-3 overflow-hidden mb-5">
                        <div className="row g-0">
                            <div className="col-lg-4 address-card-caption">
                                <div className="h-100 d-flex flex-column p-3 p-sm-4 p-md-5 p-lg-4 p-xl-5">
