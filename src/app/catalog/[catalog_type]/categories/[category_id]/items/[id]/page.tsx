...
async function getService(id: string, category_id: string, catalog_type: string) {
    const res = await fetch(
        `${process.env.YZI4D_HOST}/catalog/${catalog_type}/categories/${category_id}/items/${id}`,
                            ...
                            <div className="col-12 col-md-auto">
                                <div className="h-100 d-flex flex-column">
                                    <div className="d-flex align-items-end mb-3">
                                        {/* <!-- ВИД ЦЕНЫ СО СКИДКОЙ: -->
                                        <!-- <div className="me-3">
                                            <div className="text-decoration-line-through text-disabled lh-1 mb-1">3 500 ₽</div>
                                    ...
                                    {/* <a href="#" className="btn btn-danger">Записаться</a> */}
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="col-xxl-9 col-xl-8">
                            <div className="bg-white rounded-3 shadow px-3 pb-3 px-md-4 pt-md-2 pb-md-4 px-lg-5 pt-lg-3 pb-lg-5">
                                ...
                                <div className="tab-content" id="service-tabContent">
                                    ...
                                    {/* <div className="tab-pane fade" id="service-2" role="tabpanel" aria-labelledby="service-2-tab" tabIndex={0}>
                                            <div className="article article-sm">
                                                <ul>
                                                    <li>затруднение при мочеиспускании, постоянное чувство наполненности мочевого пузыря;</li>
                                                    ...
                                                    <li>мужчинам старше 40 лет рекомендовано проведение исследования в целях профилактики в качестве скрининга</li>
                                                </ul>
                                            </div>
                                        </div> */}

                                    {/* <div className="tab-pane fade" id="service-3" role="tabpanel" aria-labelledby="service-3-tab" tabIndex={0}>
                                            <div className="article article-sm">
                                                <p>Трансабдоминальное исследование противопоказаний не имеет.</p>
                                                <p>
                                                    Трансректальное исследование не проводится при заболеваниях и повреждениях прямой кишки (геморрой, анальные трещины); также не
                                                    рекомендовано проведение исследования несколько дней после колоноскопии.
                                                </p>
                                            </div>
                                        </div> */}
